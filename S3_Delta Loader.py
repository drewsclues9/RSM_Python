...
mapping_query = "SELECT SNOWFLAKE_TABLE, SAP_TABLE, STG_TBL FROM STG_TBL_LOOKUP;"
cur.execute(mapping_query)

# Fetch data and convert it into a DataFrame
columns = ['SNOWFLAKE_TABLE','SAP_TABLE', 'STG_TBL']  # Get column names
