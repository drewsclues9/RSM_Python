...
mapping_query = "SELECT * FROM REF_TBL_LOOKUP;"
...
folder_path = "C:/Users/E075882/RSM/Project Galaxy - External Project Documents/DDS/Data Migration/01- Data Extracts/Reference/RDTA"
...
for index, row in mapdf.iterrows():
    ...
    for filename in os.listdir(folder_path):
        ...
        if mapdf.loc[index, 'SAP_TABLE'] in filename.upper():
            ...
            create_table_query = f"CREATE OR REPLACE TABLE {table_name} ({', '.join(columns)});"
